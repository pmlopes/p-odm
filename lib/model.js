...
/**
 * @private
 * Debug function to log all queries
 */
function queryLog(collectionName, single, args) {
//  var _args = Array.prototype.slice.call(args);
//  console.log(collectionName + '.' + (single ? 'findOne' : 'find') + '(' + JSON.stringify(_args) + ')');
}
          ...
          Object.defineProperty(model, key, {
            get: function() {
              if(model._internalDocument[key] !== undefined) {
                return schema[key].$get.call(model, model._internalDocument[key]);
              }
            },
            set: function(value) {
          ...
          Object.defineProperty(model, key, {
            get: function() {
              if(model._internalDocument[key] !== undefined) {
                ...
                submodel.toJSON = function() {
                  return this._internalDocument;
                };
                submodel.toString = function() {
...
module.exports = function (mongoCollection, l2cache, schema) {
  ...
  var Model = function (values, options) {
    ...
    var v0 = JSON.stringify(values);
    Object.defineProperty(this, '_internalDocument', {value: __initialize(internalSchema, values, loadOrSet)});
    var v1 = JSON.stringify(values);

    if(v0 != v1) {
      console.error(mongoCollection);
      console.error(v0);
      console.error(v1);
    }
  ...
  Model.findOne = function (query, options, callback) {
    ...
    queryLog(mongoCollection, true, arguments);
...
//            console.log('HIT ' + mongoCollection + ' ' + _id.toHexString());
  ...
  Model.find = function (query, fields, options, callback) {
    ...
    queryLog(mongoCollection, false, arguments);
...
//        console.log('HIT ' + mongoCollection + ' all');
  ...
  Model.prototype.remove = function (options, callback) {
    ...
    odm.collection(mongoCollection, {}, function (err, collection) {
      ...
      collection.remove({ _id:this._id }, options, callback);
    });
  };
