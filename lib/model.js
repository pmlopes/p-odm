...
function extend(obj, proto, deep) {
  if (deep) {
    statistics.deepExtend++;
  } else {
    statistics.extend++;
  }
  if (obj !== undefined && obj !== null && proto !== undefined && proto !== null) {
    var key;
    for (key in proto) {
...
module.exports = function (mongoCollection, schemaDef) {
  ...
  Model.findOne = function (query, fields, options, callback) {
    ...
    var wantExtend = extractOption('extend', options, false);
    var wantExtendDeep = extractOption('deepExtend', options, false);
    if (wantExtend) statistics.wantExtend++;
    if (wantExtendDeep) statistics.wantDeepExtend++;
  ...
  Model.loadDbRef = function (ids, fields, options, callback) {
    ...
    if (Array.isArray(ids)) {
      ...
      options.extend = wantExtend;
      options.deepExtend = wantExtendDeep;
      if (pluck !== undefined) {
        options.pluck = pluck;
      }
