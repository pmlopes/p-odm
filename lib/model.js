          ...
          Object.defineProperty(model, key, {
            get: function() {
              if(model._internalDocument[key] !== undefined) {
                ...
                if(schema[key].$push) {
                  // TODO: match the Array.push signature
                  value.push = function(obj) {
                    schema[key].$push.call(model, model._internalDocument[key], obj);
                  };
                }
                return value;
              }
...
function __buildInternalValue(key, type) {
  ...
  if (Array.isArray(type)) {
    ...
    internalValue.$push = function (array, value) {
      var retValue;
      if (arrayInternalValue.$set !== undefined) {
        // simple type
        retValue = arrayInternalValue.$set(value);
      } else {
        // embedded doc types
        retValue = _baseArrayLoadOrSetter(arrayInternalValue, '$set', value);
      }
