...
function findIndexInArray(array, query) {
...
function findOneInArray(array, query) {
...
function removeInArray(array, query) {
...
module.exports = {
  ...
  findOneInArray: findOneInArray,
  findByIdInArray: findByIdInArray,
